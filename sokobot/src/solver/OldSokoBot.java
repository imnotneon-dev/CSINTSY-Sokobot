...
public class OldSokoBot {

    public String solveSokobanPuzzle(int width, int height, char[][] mapData, char[][] itemsData) {

        // get coordinates of player
        int[] startingPoint = OldSokoBot.getCoordinates(width, height, mapData, itemsData, '@');
        // get coordinatess of goal points for the boxes
        int[][] goalPoints = OldSokoBot.getGoalStates(width, height, mapData);
        // get coordinates of boxes
        int[][] boxStartPoint = OldSokoBot.getBoxPoints(width, height, itemsData, '$', goalPoints.length);
